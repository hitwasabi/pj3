...
@section('title',"Danh sách phòng trọ quận Hai Bà Trưng")
        ...
        <div class="auto-container">
            <div class="content-box clearfix">
                ...
                <ul class="bread-crumb clearfix">
                    ...
                    <li>Danh sách phòng trọ quận Hai Bà Trưng</li>
                </ul>
            </div>
        </div>
    </section>
                    ...
                    <div class="property-content-side">
                        <div class="item-shorting clearfix">
                            <div class="left-column pull-left">
                                <h5>Danh sách phòng trọ quận Hai Bà Trưng:{{ $rent_rooms->total() }} kết quả </h5>
                            </div>
