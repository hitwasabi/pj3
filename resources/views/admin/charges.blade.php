...
@section('title',"Nạp tiền cho chủ trọ")
        ...
        ***********************************-->
        <div class="content-body">
            ...
            <div class="page-titles">
                <ol class="breadcrumb">
                    <li><h5 class="bc-title">Nạp tiền</h5></li>
                </ol>
            </div>
                                    ...
                                    <table id="contacts-tbl" class="table">
                                        ...
                                        @foreach($agents as $agent)
                                            <tr>
                                                ...
                                                @endif
                                                <form action="{{url('admin/charges/'.$agent->id)}}" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                <td>
                                                    <input name="money" type="number" min="1" required>
                                                </td>
                                                <td>
