...
<!-- Mirrored from w3crm.dexignzone.com/xhtml/contacts.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Jun 2023 01:40:56 GMT -->
<head>
    <meta charset="utf-8">
	...
	<link href="public/admin/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
	<link href="public/admin/vendor/swiper/css/swiper-bundle.min.css" rel="stylesheet">
	<link href="https://fonts.googleapis.com/css2?family=Material+Icons" rel="stylesheet">
	<link href="public/admin/vendor/datatables/css/jquery.dataTables.min.css" rel="stylesheet">
...
<body data-typography="poppins" data-theme-version="light" data-layout="vertical" data-nav-headerbg="black" data-headerbg="color_1">
    ...
    ***********************************-->
    <!-- Required vendors -->
    <script src="public/admin/vendor/global/global.min.js"></script>
	<script src="public/admin/vendor/bootstrap-select/dist/js/bootstrap-select.min.js"></script>
	...
	<script src="public/admin/vendor/datatables/js/dataTables.buttons.min.js"></script>
	<script src="public/admin/vendor/datatables/js/buttons.html5.min.js"></script>
	<script src="public/admin/vendor/datatables/js/jszip.min.js"></script>
	<script src="public/admin/js/plugins-init/datatables.init.js"></script>

	<!-- Apex Chart -->

	<script src="public/admin/vendor/tagify/dist/tagify.js"></script>


	<!-- Vectormap -->
    <script src="public/admin/js/custom.js"></script>
	<script src="public/admin/js/deznav-init.js"></script>
