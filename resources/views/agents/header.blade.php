...
<div class="nav-header">
    <a href="{{url('/client/home')}}" class="brand-logo">
        ...
        <nav class="navbar navbar-expand">
            <div class="collapse navbar-collapse justify-content-between">
                ...
                <ul class="navbar-nav header-right">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" style="">
                                <div class="card border-0 mb-0">
                                    <div class="card-header py-2">
                                        <div class="products">
                                            @if(\Illuminate\Support\Facades\Auth::user()->user_image == null)
                                                <img src="{{url('data:image/png;base64,')}}" class="avatar avatar-md" alt="">
                                            @else
                                    ...
                                    <div class="card-body px-0 py-2">
                                        <a href="{{url('agents/agents-profile')}}" class="dropdown-item ai-icon ">
                                            ...
                                            <span class="ms-2">Thông tin của tôi </span>
                                        </a>
                                        <a href="{{url('agents/ecom-product-list')}}" class="dropdown-item ai-icon ">
                                            ...
                                            <span class="ms-2">Danh mục phòng trọ của tôi</span><span class="badge badge-sm badge-secondary light rounded-circle text-white ms-2"></span>
                                        </a>
                                    </div>
                                    <div class="card-footer px-0 py-2">
                                        <a href="{{url('agents/edit-profile')}}" class="dropdown-item ai-icon ">
                                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <span class="ms-2">Sửa thông tin</span>
                                        </a>
                    ...
                    <li class="nav-item align-items-center header-border"><a href="{{url('/logout')}}" class="btn btn-primary btn-sm">Đăng xuất</a></li>
                </ul>
            </div>
        </nav>
    </div>
